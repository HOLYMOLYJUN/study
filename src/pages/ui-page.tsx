...
import AlertDialogExample from "@/components/ui/examples/alert-dialog-example";
import ToastExample from "@/components/ui/examples/toast-example";
...
export default function UIPage() {
  return (
    <PageProvider>
      <div className="container mx-auto space-y-8 p-8 px-0">
